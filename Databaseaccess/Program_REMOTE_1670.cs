...
namespace Testing_final
{
    ...
    public partial class DatabaseMethods
    {
        ...
        ///////////////////////////////////////////////////// Method to retreive data from L1 tests table to display on second window ///////////////////////////////////////////////////////////

        public static IQueryable<L1test> GetL1testtableinfo(string nameoftest)
        {

            var queryHardware =
                from c in Database.L1tests
                where c.Testname == nameoftest
                select c;

            return queryHardware;
        }
        ///////////////////////////////////////////////////// Method to retreive data from testcaselogs table to display on second window ///////////////////////////////////////////////////////////
/*
        public static IQueryable<Testcaselog> Gettestcaselogtableinfo(string nameoftest)
        {

            var querytestcasetable =
                from c in Database.Testcaselogs
                where c.Testname == nameoftest
                select c;

            return querytestcasetable;
        }
  */      
        ////////////new///////////////////////////////////////// Method to retreive data from testcaselogs table  ///////////////////////////////////////////////////////////

        public static IQueryable<Occurances1> Gettestcaselogtableinfo(string nameoftest)
        {

            var querytestcasetable =
                from c in Database.Testcaselogs
                from d in Database.mappings.RightJoin(dc => dc.Tcid == c.Tcid)
                where c.Testname == nameoftest

                select new Occurances1(c.Testname, c.Testresult, d.Testcasename, c.Reqid, c.Tcid, c.Ecu);
        ...
        public static IQueryable<Failure> FilterFailuresNameStatus( TestStatus state)
        {
            ...
            stopWatch.Stop();
            Console.WriteLine($"Popullating Failures in dropdown Time: {stopWatch.ElapsedMilliseconds} ms ");
        ...
        public static IQueryable<Occurances> MatchOccurances(string idtomatch, string auswertungtomatch)

        {
            ...
            var occurances =
                ...
                & c.Tcid == idtomatch
                    ...
                    select new Occurances(c.Testname, c.Procstatus,d.Clusterno);
        ...
        public static void Updatefailuretablestatus(int id, TestStatus Newstate)
        {
            ...
            Database.Failures.Where(a => a.Uuid == id)
                                        ...
                                        .Set(a => a.Lastedited, new DateTimeOffset(DateTime.Now))
                                        //.Set(a => a.Procstatus, ()  => changedValue)
                                        .Update();

        }

        ///////////////////////////////////////////////////// Method to update status in testcase table ///////////////////////////////////////////////////////////

        public static void Updatetestcasestatus(string nameoftest, string reqid, string tcid, string Newresult)
        {

            Database.Testcaselogs.Where(a => a.Testname == nameoftest & a.Tcid == tcid & a.Reqid == reqid)

                                        .Set(a => a.Testresult, Newresult)
